    ...
    public void onUnlock(UnlockTalentEvent.Post event) {
        if (event.getTalent() instanceof TalentShadow) {
            ...
            if (!player.world.isRemote) {
                ...
                IAttributeInstance AttributeSpeed = player.getEntityAttribute(this.speed);
                ...
                IAttributeInstance AttributeThreat = player.getEntityAttribute(this.threat);
                ...
                IAttributeInstance AttributeStealth = player.getEntityAttribute(this.stealth);
